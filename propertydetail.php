        ...
        <div class="full-row">
            <div class="container">
                <div class="row"> 
					...
					<?php
						$id=$_REQUEST['pid']; 
						$query=mysqli_query($con,"SELECT property.*, user.* FROM `property`,`user` WHERE property.uid=user.uid and property.pid='$id'");
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <a href="booking.php?pid=<?php echo $row['0'];?>" class="btn btn-primary px-5 ml-auto mr-3">Book Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="property-details">
                            ...
                            <h4 class="text-secondary mt-4 mb-4">Description</h4>
                            <p><?php echo $row['2'];?></p>
                            
                            <h5 class="mt-2 mb-4 text-secondary">Property Summary</h5>
