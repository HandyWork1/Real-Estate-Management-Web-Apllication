...
if(isset($_POST['insert']))
{
	...
	if(!empty($state) && !empty($city)){
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>Area Inserted Successfully</p>";
						
			}
			else
			{
				$error="<p class='alert alert-warning'>* Area Not Inserted</p>";
			}
	}
	else{
...
<head>
        ...
        <title> Starlink Properties - Data Tables</title>
