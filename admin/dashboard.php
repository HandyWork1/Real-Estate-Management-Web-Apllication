...
<head>
        ...
        <title> Starlink Properties - Dashboard</title>
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group row">
												<a href="../register.php" class="btn btn-success btn-icon-split btn-bg ml-3 ">
													<i class="fe fe-user-plus btn-success mr-1"></i>
													Register User
												</a>
											</div>
										</div>
