...
require("config.php");
require("property_add_logic.php");  
...
// Create an instance of the PropertyProcessor class
$propertyProcessor = new PropertyProcessor($con);
...
if (isset($_POST['add'])) {
    $result = $propertyProcessor->processPropertyAddition($_POST);
    $error = $result['error'];
    $msg = $result['msg'];
}
...
<head>
        ...
        <title> Starlink Properties | Property</title>
