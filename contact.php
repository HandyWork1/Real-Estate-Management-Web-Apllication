...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Argwings Kodhek, Hurlingham</span> <br>
										<span class="text-white">Biashara Building</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+254 702-622-845</span>
										<span class="text-white">+254 725-255-627 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">helpline@starlink.ac.ke</span>
										<span class="text-white">sales@starlink.ac.ke</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDPYPxZ5zqo4e6BZUMd5GwnWHxIu4yd6yU&q=Hurlingham%20Plaza&center=-1.295125,36.798065" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
