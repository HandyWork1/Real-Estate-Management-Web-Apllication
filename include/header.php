                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+254 725-255-627</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>sales@starlink.ac.ke</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                                    ...
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item"> <a class="nav-link" href="feature.php">Your Bookings</a> </li>
